  ...
  apisidebar: [
    ...
    },
    {
      ...
      items: [
        {
          type: "doc",
          id: "superplatform/save-definition",
          label: "Register a Definition",
          className: "api-method put",
        },
        {
          type: "doc",
          id: "superplatform/delete-definition",
          label: "Delete Definition",
          className: "api-method delete",
        },
        {
          type: "doc",
          id: "superplatform/list-definitions",
          label: "List Definitions",
          className: "api-method get",
        },
        {
          type: "doc",
          id: "superplatform/register-instance",
          label: "Register Instance",
          className: "api-method put",
        },
        {
          type: "doc",
          id: "superplatform/remove-instance",
          label: "Remove Instance",
          className: "api-method delete",
        },
        {
          type: "doc",
          id: "superplatform/list-instances",
