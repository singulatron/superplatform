...
Singulatron is a rapid prototyping environment for the AI age. It aims to serve the hackers (or at least the author(s)) who embark on transforming the world with AI over the next decade.
