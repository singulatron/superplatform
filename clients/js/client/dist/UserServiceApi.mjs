...
import { UsertypesChangePasswordAdminRequestToJSON } from './UsertypesChangePasswordAdminRequest.mjs';
import { UsertypesChangePasswordRequestToJSON } from './UsertypesChangePasswordRequest.mjs';
import { UsertypesCreateRoleRequestToJSON } from './UsertypesCreateRoleRequest.mjs';
import { UsertypesCreateRoleResponseFromJSON } from './UsertypesCreateRoleResponse.mjs';
import { UsertypesCreateUserRequestToJSON } from './UsertypesCreateUserRequest.mjs';
import { UsertypesGetPermissionsResponseFromJSON } from './UsertypesGetPermissionsResponse.mjs';
import { UsertypesGetPublicKeyResponseFromJSON } from './UsertypesGetPublicKeyResponse.mjs';
import { UsertypesGetRolesResponseFromJSON } from './UsertypesGetRolesResponse.mjs';
import { UsertypesGetUsersRequestToJSON } from './UsertypesGetUsersRequest.mjs';
import { UsertypesGetUsersResponseFromJSON } from './UsertypesGetUsersResponse.mjs';
import { UsertypesIsAuthorizedRequestToJSON } from './UsertypesIsAuthorizedRequest.mjs';
import { UsertypesIsAuthorizedResponseFromJSON } from './UsertypesIsAuthorizedResponse.mjs';
import { UsertypesLoginRequestToJSON } from './UsertypesLoginRequest.mjs';
import { UsertypesLoginResponseFromJSON } from './UsertypesLoginResponse.mjs';
import { UsertypesReadUserByTokenRequestToJSON } from './UsertypesReadUserByTokenRequest.mjs';
import { UsertypesReadUserByTokenResponseFromJSON } from './UsertypesReadUserByTokenResponse.mjs';
import { UsertypesRegisterRequestToJSON } from './UsertypesRegisterRequest.mjs';
import { UsertypesSetRolePermissionsRequestToJSON } from './UsertypesSetRolePermissionsRequest.mjs';
import { UsertypesUpserPermissionRequestToJSON } from './UsertypesUpserPermissionRequest.mjs';
import './UsertypesRole.mjs';
import './UsertypesUser.mjs';
import './UsertypesPermission.mjs';
...
class UserServiceApi extends BaseAPI {
    ...
    createRoleRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new JSONApiResponse(response, (jsonValue) => UsertypesCreateRoleResponseFromJSON(jsonValue));
        });
    }
    /**
     * Create a new role. <b>The role ID must be prefixed by the callers username (email).</b> Eg. if the owner\'s email/username is `petstore-svc` the role should look like `petstore-svc:admin`. The user account who creates the role will become the owner of that role, and only the owner will be able to edit the role.  Requires the `user-svc:role:create` permission.
    ...
    getPermissionsByRoleRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new JSONApiResponse(response, (jsonValue) => UsertypesGetPermissionsResponseFromJSON(jsonValue));
        });
    }
    /**
     * Retrieve permissions associated with a specific role ID.
    ...
    getPublicKeyRaw(initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new JSONApiResponse(response, (jsonValue) => UsertypesGetPublicKeyResponseFromJSON(jsonValue));
        });
    }
    /**
     * Get the public key to descrypt the JWT.
    ...
    getRolesRaw(initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new JSONApiResponse(response, (jsonValue) => UsertypesGetRolesResponseFromJSON(jsonValue));
        });
    }
    /**
     * Retrieve all roles from the user service.
    ...
    getUserByTokenRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters['body'] == null) {
                throw new RequiredError('body', 'Required parameter "body" was null or undefined when calling getUserByToken().');
            }
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json';
            ...
            return new JSONApiResponse(response, (jsonValue) => UsertypesReadUserByTokenResponseFromJSON(jsonValue));
        });
    }
    /**
     * Retrieve user information based on an authentication token.
    ...
    getUsersRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new JSONApiResponse(response, (jsonValue) => UsertypesGetUsersResponseFromJSON(jsonValue));
        });
    }
    /**
     * Fetches a list of users with optional query filters and pagination.
    ...
    isAuthorizedRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new JSONApiResponse(response, (jsonValue) => UsertypesIsAuthorizedResponseFromJSON(jsonValue));
        });
    }
    /**
     * Check if a user is authorized for a specific permission.
    ...
    loginRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new JSONApiResponse(response, (jsonValue) => UsertypesLoginResponseFromJSON(jsonValue));
        });
    }
    /**
     * Authenticates a user and returns a token.
