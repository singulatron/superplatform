import { NodeSvcProcessFromJSON, NodeSvcProcessToJSON } from './NodeSvcProcess.mjs';
...
export { NodeSvcGPUFromJSON, NodeSvcGPUFromJSONTyped, NodeSvcGPUToJSON, instanceOfNodeSvcGPU };
