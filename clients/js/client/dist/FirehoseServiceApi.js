...
var FirehosetypesPublishRequest = require('./FirehosetypesPublishRequest.js');
require('./FirehosetypesEvent.js');
 ...
 *
 */
class FirehoseServiceApi extends runtime.BaseAPI {
    /**
    ...
    firehoseSvcPublishPostRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                body: FirehosetypesPublishRequest.FirehosetypesPublishRequestToJSON(requestParameters['event']),
            }, initOverrides);
...
exports.FirehoseServiceApi = FirehoseServiceApi;
