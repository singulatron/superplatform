...
import { PrompttypesAddPromptRequestToJSON } from './PrompttypesAddPromptRequest.mjs';
import { PrompttypesAddPromptResponseFromJSON } from './PrompttypesAddPromptResponse.mjs';
import { PrompttypesListPromptsRequestToJSON } from './PrompttypesListPromptsRequest.mjs';
import { PrompttypesListPromptsResponseFromJSON } from './PrompttypesListPromptsResponse.mjs';
import { PrompttypesRemovePromptRequestToJSON } from './PrompttypesRemovePromptRequest.mjs';
import './PrompttypesPrompt.mjs';
 ...
 *
 */
class PromptServiceApi extends BaseAPI {
    /**
    ...
    addPromptRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new JSONApiResponse(response, (jsonValue) => PrompttypesAddPromptResponseFromJSON(jsonValue));
        });
    }
    /**
     * Adds a new prompt to the prompt queue and either waits for the response (if `sync` is set to true), or returns immediately.
    ...
    getPromptsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new JSONApiResponse(response, (jsonValue) => PrompttypesListPromptsResponseFromJSON(jsonValue));
        });
    }
    /**
     * List prompts that satisfy a query.
