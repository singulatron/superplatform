...
var PrompttypesAddPromptRequest = require('./PrompttypesAddPromptRequest.js');
var PrompttypesAddPromptResponse = require('./PrompttypesAddPromptResponse.js');
var PrompttypesListPromptsRequest = require('./PrompttypesListPromptsRequest.js');
var PrompttypesListPromptsResponse = require('./PrompttypesListPromptsResponse.js');
var PrompttypesRemovePromptRequest = require('./PrompttypesRemovePromptRequest.js');
require('./PrompttypesPrompt.js');
 ...
 *
 */
class PromptServiceApi extends runtime.BaseAPI {
    /**
    ...
    addPromptRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                body: PrompttypesAddPromptRequest.PrompttypesAddPromptRequestToJSON(requestParameters['request']),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => PrompttypesAddPromptResponse.PrompttypesAddPromptResponseFromJSON(jsonValue));
        });
    }
    /**
     * Adds a new prompt to the prompt queue and either waits for the response (if `sync` is set to true), or returns immediately.
    ...
    getPromptsRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: PrompttypesListPromptsRequest.PrompttypesListPromptsRequestToJSON(requestParameters['request']),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => PrompttypesListPromptsResponse.PrompttypesListPromptsResponseFromJSON(jsonValue));
        });
    }
    /**
     * List prompts that satisfy a query.
    ...
    removePromptRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: PrompttypesRemovePromptRequest.PrompttypesRemovePromptRequestToJSON(requestParameters['request']),
            }, initOverrides);
...
exports.PromptServiceApi = PromptServiceApi;
