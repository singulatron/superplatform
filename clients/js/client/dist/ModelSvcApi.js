...
class ModelSvcApi extends runtime.BaseAPI {
    ...
    getModelRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => ModelSvcGetModelResponse.ModelSvcGetModelResponseFromJSON(jsonValue));
        });
    }
    /**
     * Retrieves the details of a model by its ID.  the Requires `model.view` permission.
    ...
    listModelsRaw(initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => ModelSvcListResponse.ModelSvcListResponseFromJSON(jsonValue));
        });
    }
    /**
     * Retrieves a list of models.  Requires `model-svc:model:view` permission.
...
exports.ModelSvcApi = ModelSvcApi;
