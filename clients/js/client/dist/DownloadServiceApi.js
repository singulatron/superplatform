...
var DownloadtypesDownloadRequest = require('./DownloadtypesDownloadRequest.js');
var DownloadtypesDownloadsResponse = require('./DownloadtypesDownloadsResponse.js');
var DownloadtypesGetDownloadResponse = require('./DownloadtypesGetDownloadResponse.js');
require('./DownloadtypesDownloadDetails.js');
 ...
 *
 */
class DownloadServiceApi extends runtime.BaseAPI {
    /**
    ...
    downloadRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                body: DownloadtypesDownloadRequest.DownloadtypesDownloadRequestToJSON(requestParameters['request']),
            }, initOverrides);
    ...
    getDownloadRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => DownloadtypesGetDownloadResponse.DownloadtypesGetDownloadResponseFromJSON(jsonValue));
        });
    }
    /**
     * Get a download by ID.  Requires the `download-svc:download:view` permission.
    ...
    listDownloadsRaw(initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => DownloadtypesDownloadsResponse.DownloadtypesDownloadsResponseFromJSON(jsonValue));
        });
    }
    /**
     * Fetch a list of all download details.  Requires the `download-svc:download:view` permission.
...
exports.DownloadServiceApi = DownloadServiceApi;
