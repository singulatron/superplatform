...
import { ChatAddMessageRequestToJSON, ChatAddThreadRequestToJSON, ChatAddThreadResponseFromJSON, ChatGetMessagesResponseFromJSON, ChatGetThreadResponseFromJSON, ChatGetThreadsResponseFromJSON, ChatUpdateThreadRequestToJSON, } from '../models/index';
/**
 *
 */
export class ChatServiceApi extends runtime.BaseAPI {
    ...
    addMessageRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                body: ChatAddMessageRequestToJSON(requestParameters['request']),
            }, initOverrides);
    ...
    addThreadRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: ChatAddThreadRequestToJSON(requestParameters['request']),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => ChatAddThreadResponseFromJSON(jsonValue));
        });
    }
    /**
     * Create a new chat thread and add the requesting user to it. Requires the `chat-svc:thread:create` permission.
    ...
    getMessagesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => ChatGetMessagesResponseFromJSON(jsonValue));
        });
    }
    /**
     * Fetch messages (and associated assets) for a specific chat thread.
    ...
    getThreadRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => ChatGetThreadResponseFromJSON(jsonValue));
        });
    }
    /**
     * Fetch information about a specific chat thread by its ID
    ...
    getThreadsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => ChatGetThreadsResponseFromJSON(jsonValue));
        });
    }
    /**
     * Fetch all chat threads associated with a specific user
    ...
    updateThreadRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: ChatUpdateThreadRequestToJSON(requestParameters['request']),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => ChatAddThreadResponseFromJSON(jsonValue));
        });
    }
