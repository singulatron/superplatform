...
import { DownloadDownloadRequestToJSON, DownloadDownloadsResponseFromJSON, DownloadGetDownloadResponseFromJSON, } from '../models/index';
/**
 *
 */
export class DownloadServiceApi extends runtime.BaseAPI {
    ...
    downloadRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                body: DownloadDownloadRequestToJSON(requestParameters['request']),
            }, initOverrides);
    ...
    getDownloadRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => DownloadGetDownloadResponseFromJSON(jsonValue));
        });
    }
    /**
     * Get a download by ID.  Requires the `download-svc:download:view` permission.
    ...
    listDownloadsRaw(initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => DownloadDownloadsResponseFromJSON(jsonValue));
        });
    }
    /**
     * Fetch a list of all download details.  Requires the `download-svc:download:view` permission.
