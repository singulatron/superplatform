 ...
 */
function instanceOfModeltypesModel(value) {
    return true;
}
function ModeltypesModelFromJSON(json) {
    return ModeltypesModelFromJSONTyped(json);
}
function ModeltypesModelFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function ModeltypesModelToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
...
exports.ModeltypesModelFromJSON = ModeltypesModelFromJSON;
exports.ModeltypesModelFromJSONTyped = ModeltypesModelFromJSONTyped;
exports.ModeltypesModelToJSON = ModeltypesModelToJSON;
exports.instanceOfModeltypesModel = instanceOfModeltypesModel;
