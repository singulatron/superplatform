...
function RegistrySvcGPUFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'processDetails': json['processDetails'] == null ? undefined : (json['processDetails'].map(RegistrySvcProcess.RegistrySvcProcessFromJSON)),
...
function RegistrySvcGPUToJSON(value) {
    ...
    return {
        ...
        'processDetails': value['processDetails'] == null ? undefined : (value['processDetails'].map(RegistrySvcProcess.RegistrySvcProcessToJSON)),
