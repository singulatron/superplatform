 ...
 */
function instanceOfNodeSvcGPU(value) {
    return true;
}
function NodeSvcGPUFromJSON(json) {
    return NodeSvcGPUFromJSONTyped(json);
}
function NodeSvcGPUFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
        ...
        'processDetails': json['processDetails'] == null ? undefined : (json['processDetails'].map(NodeSvcProcess.NodeSvcProcessFromJSON)),
        'temperature': json['temperature'] == null ? undefined : json['temperature'],
    };
}
function NodeSvcGPUToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
        ...
        'processDetails': value['processDetails'] == null ? undefined : (value['processDetails'].map(NodeSvcProcess.NodeSvcProcessToJSON)),
        'temperature': value['temperature'],
    };
}

exports.NodeSvcGPUFromJSON = NodeSvcGPUFromJSON;
exports.NodeSvcGPUFromJSONTyped = NodeSvcGPUFromJSONTyped;
exports.NodeSvcGPUToJSON = NodeSvcGPUToJSON;
exports.instanceOfNodeSvcGPU = instanceOfNodeSvcGPU;
