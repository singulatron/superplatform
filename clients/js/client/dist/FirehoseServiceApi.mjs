...
import { FirehosetypesPublishRequestToJSON } from './FirehosetypesPublishRequest.mjs';
import './FirehosetypesEvent.mjs';
 ...
 *
 */
class FirehoseServiceApi extends BaseAPI {
    /**
