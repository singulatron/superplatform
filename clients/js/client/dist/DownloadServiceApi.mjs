...
import { DownloadtypesDownloadRequestToJSON } from './DownloadtypesDownloadRequest.mjs';
import { DownloadtypesDownloadsResponseFromJSON } from './DownloadtypesDownloadsResponse.mjs';
import { DownloadtypesGetDownloadResponseFromJSON } from './DownloadtypesGetDownloadResponse.mjs';
import './DownloadtypesDownloadDetails.mjs';
 ...
 *
 */
class DownloadServiceApi extends BaseAPI {
    /**
    ...
    getDownloadRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new JSONApiResponse(response, (jsonValue) => DownloadtypesGetDownloadResponseFromJSON(jsonValue));
        });
    }
    /**
     * Get a download by ID.  Requires the `download-svc:download:view` permission.
    ...
    listDownloadsRaw(initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new JSONApiResponse(response, (jsonValue) => DownloadtypesDownloadsResponseFromJSON(jsonValue));
        });
    }
    /**
     * Fetch a list of all download details.  Requires the `download-svc:download:view` permission.
