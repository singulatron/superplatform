 ...
 */
export function instanceOfGenerictypesQueryRequest(value) {
    return true;
}
export function GenerictypesQueryRequestFromJSON(json) {
    return GenerictypesQueryRequestFromJSONTyped(json, false);
}
export function GenerictypesQueryRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function GenerictypesQueryRequestToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
