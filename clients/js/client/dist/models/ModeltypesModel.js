 ...
 */
export function instanceOfModeltypesModel(value) {
    return true;
}
export function ModeltypesModelFromJSON(json) {
    return ModeltypesModelFromJSONTyped(json, false);
}
export function ModeltypesModelFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function ModeltypesModelToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
