 ...
 */
export function instanceOfDynamicSvcObject(value) {
...
export function DynamicSvcObjectFromJSON(json) {
    return DynamicSvcObjectFromJSONTyped(json, false);
}
export function DynamicSvcObjectFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function DynamicSvcObjectToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
