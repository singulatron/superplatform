 ...
 */
export function instanceOfUsertypesUser(value) {
    return true;
}
export function UsertypesUserFromJSON(json) {
    return UsertypesUserFromJSONTyped(json, false);
}
export function UsertypesUserFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function UsertypesUserToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
