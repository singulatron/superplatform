 ...
 */
export function instanceOfDownloadSvcDownloadDetails(value) {
    return true;
}
export function DownloadSvcDownloadDetailsFromJSON(json) {
    return DownloadSvcDownloadDetailsFromJSONTyped(json, false);
}
export function DownloadSvcDownloadDetailsFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function DownloadSvcDownloadDetailsToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
