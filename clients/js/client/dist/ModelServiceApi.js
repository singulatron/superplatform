...
var ModeltypesGetModelResponse = require('./ModeltypesGetModelResponse.js');
var ModeltypesListResponse = require('./ModeltypesListResponse.js');
var ModeltypesStatusResponse = require('./ModeltypesStatusResponse.js');
require('./ModeltypesModel.js');
require('./ModeltypesPlatform.js');
require('./ModeltypesArchitectures.js');
require('./ModeltypesContainer.js');
require('./ModeltypesModelStatus.js');
 ...
 *
 */
class ModelServiceApi extends runtime.BaseAPI {
    /**
    ...
    getModelRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => ModeltypesGetModelResponse.ModeltypesGetModelResponseFromJSON(jsonValue));
        });
    }
    /**
     * Retrieves the details of a model by its ID.  the Requires `model.view` permission.
    ...
    getModelStatusRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => ModeltypesStatusResponse.ModeltypesStatusResponseFromJSON(jsonValue));
        });
    }
    /**
     * Retrieves the status of a model by ID.  Requires the `model-svc:model:view` permission.
    ...
    listModelsRaw(initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => ModeltypesListResponse.ModeltypesListResponseFromJSON(jsonValue));
        });
    }
    /**
     * Retrieves a list of models after checking authorization Requires \"model.view\" permission.
...
exports.ModelServiceApi = ModelServiceApi;
