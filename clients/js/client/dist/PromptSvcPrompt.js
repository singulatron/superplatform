...
function PromptSvcPromptFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'status': json['status'] == null ? undefined : PromptSvcPromptStatus.PromptSvcPromptStatusFromJSON(json['status']),
...
function PromptSvcPromptToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
        ...
        'status': PromptSvcPromptStatus.PromptSvcPromptStatusToJSON(value['status']),
        'sync': value['sync'],
...
exports.PromptSvcPromptFromJSON = PromptSvcPromptFromJSON;
exports.PromptSvcPromptFromJSONTyped = PromptSvcPromptFromJSONTyped;
exports.PromptSvcPromptToJSON = PromptSvcPromptToJSON;
exports.instanceOfPromptSvcPrompt = instanceOfPromptSvcPrompt;
