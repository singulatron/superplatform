...
var UsertypesChangePasswordAdminRequest = require('./UsertypesChangePasswordAdminRequest.js');
var UsertypesChangePasswordRequest = require('./UsertypesChangePasswordRequest.js');
var UsertypesCreateRoleRequest = require('./UsertypesCreateRoleRequest.js');
var UsertypesCreateRoleResponse = require('./UsertypesCreateRoleResponse.js');
var UsertypesCreateUserRequest = require('./UsertypesCreateUserRequest.js');
var UsertypesGetPermissionsResponse = require('./UsertypesGetPermissionsResponse.js');
var UsertypesGetPublicKeyResponse = require('./UsertypesGetPublicKeyResponse.js');
var UsertypesGetRolesResponse = require('./UsertypesGetRolesResponse.js');
var UsertypesGetUsersRequest = require('./UsertypesGetUsersRequest.js');
var UsertypesGetUsersResponse = require('./UsertypesGetUsersResponse.js');
var UsertypesIsAuthorizedRequest = require('./UsertypesIsAuthorizedRequest.js');
var UsertypesIsAuthorizedResponse = require('./UsertypesIsAuthorizedResponse.js');
var UsertypesLoginRequest = require('./UsertypesLoginRequest.js');
var UsertypesLoginResponse = require('./UsertypesLoginResponse.js');
var UsertypesReadUserByTokenRequest = require('./UsertypesReadUserByTokenRequest.js');
var UsertypesReadUserByTokenResponse = require('./UsertypesReadUserByTokenResponse.js');
var UsertypesRegisterRequest = require('./UsertypesRegisterRequest.js');
var UsertypesSetRolePermissionsRequest = require('./UsertypesSetRolePermissionsRequest.js');
var UsertypesUpserPermissionRequest = require('./UsertypesUpserPermissionRequest.js');
require('./UsertypesRole.js');
require('./UsertypesUser.js');
require('./UsertypesPermission.js');
 ...
 *
 */
class UserServiceApi extends runtime.BaseAPI {
    /**
    ...
    changePasswordRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: UsertypesChangePasswordRequest.UsertypesChangePasswordRequestToJSON(requestParameters['request']),
            }, initOverrides);
            return new runtime.JSONApiResponse(response);
        });
    }
    ...
    changePasswordAdminRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: UsertypesChangePasswordAdminRequest.UsertypesChangePasswordAdminRequestToJSON(requestParameters['request']),
            }, initOverrides);
            return new runtime.JSONApiResponse(response);
        });
    }
    ...
    createRoleRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: UsertypesCreateRoleRequest.UsertypesCreateRoleRequestToJSON(requestParameters['request']),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => UsertypesCreateRoleResponse.UsertypesCreateRoleResponseFromJSON(jsonValue));
        });
    }
    /**
     * Create a new role. <b>The role ID must be prefixed by the callers username (email).</b> Eg. if the owner\'s email/username is `petstore-svc` the role should look like `petstore-svc:admin`. The user account who creates the role will become the owner of that role, and only the owner will be able to edit the role.  Requires the `user-svc:role:create` permission.
    ...
    createUserRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: UsertypesCreateUserRequest.UsertypesCreateUserRequestToJSON(requestParameters['request']),
            }, initOverrides);
            return new runtime.JSONApiResponse(response);
        });
    }
    ...
    getPermissionsByRoleRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => UsertypesGetPermissionsResponse.UsertypesGetPermissionsResponseFromJSON(jsonValue));
        });
    }
    /**
     * Retrieve permissions associated with a specific role ID.
    ...
    getPublicKeyRaw(initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => UsertypesGetPublicKeyResponse.UsertypesGetPublicKeyResponseFromJSON(jsonValue));
        });
    }
    /**
     * Get the public key to descrypt the JWT.
    ...
    getRolesRaw(initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => UsertypesGetRolesResponse.UsertypesGetRolesResponseFromJSON(jsonValue));
        });
    }
    /**
     * Retrieve all roles from the user service.
    ...
    getUserByTokenRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: UsertypesReadUserByTokenRequest.UsertypesReadUserByTokenRequestToJSON(requestParameters['body']),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => UsertypesReadUserByTokenResponse.UsertypesReadUserByTokenResponseFromJSON(jsonValue));
        });
    }
    /**
     * Retrieve user information based on an authentication token.
    ...
    getUsersRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: UsertypesGetUsersRequest.UsertypesGetUsersRequestToJSON(requestParameters['request']),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => UsertypesGetUsersResponse.UsertypesGetUsersResponseFromJSON(jsonValue));
        });
    }
    /**
     * Fetches a list of users with optional query filters and pagination.
    ...
    isAuthorizedRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: UsertypesIsAuthorizedRequest.UsertypesIsAuthorizedRequestToJSON(requestParameters['body']),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => UsertypesIsAuthorizedResponse.UsertypesIsAuthorizedResponseFromJSON(jsonValue));
        });
    }
    /**
     * Check if a user is authorized for a specific permission.
    ...
    loginRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: UsertypesLoginRequest.UsertypesLoginRequestToJSON(requestParameters['request']),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => UsertypesLoginResponse.UsertypesLoginResponseFromJSON(jsonValue));
        });
    }
    /**
     * Authenticates a user and returns a token.
    ...
    registerRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: UsertypesRegisterRequest.UsertypesRegisterRequestToJSON(requestParameters['body']),
            }, initOverrides);
            return new runtime.JSONApiResponse(response);
        });
    }
    ...
    setRolePermissionRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: UsertypesSetRolePermissionsRequest.UsertypesSetRolePermissionsRequestToJSON(requestParameters['body']),
            }, initOverrides);
            return new runtime.JSONApiResponse(response);
        });
    }
    ...
    upsertPermissionRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: UsertypesUpserPermissionRequest.UsertypesUpserPermissionRequestToJSON(requestParameters['requestBody']),
            }, initOverrides);
            return new runtime.JSONApiResponse(response);
        });
    }
