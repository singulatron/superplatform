 ...
 *
 */
class DownloadSvcApi extends runtime.BaseAPI {
    /**
    ...
    downloadRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                body: DownloadSvcDownloadRequest.DownloadSvcDownloadRequestToJSON(requestParameters['request']),
            }, initOverrides);
    ...
    getDownloadRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => DownloadSvcGetDownloadResponse.DownloadSvcGetDownloadResponseFromJSON(jsonValue));
        });
    }
    /**
     * Get a download by ID.  Requires the `download-svc:download:view` permission.
    ...
    listDownloadsRaw(initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => DownloadSvcDownloadsResponse.DownloadSvcDownloadsResponseFromJSON(jsonValue));
        });
    }
    /**
     * Fetch a list of all download details.  Requires the `download-svc:download:view` permission.
...
exports.DownloadSvcApi = DownloadSvcApi;
