...
var ConfigtypesGetConfigResponse = require('./ConfigtypesGetConfigResponse.js');
var ConfigtypesSaveConfigRequest = require('./ConfigtypesSaveConfigRequest.js');
require('./ConfigtypesConfig.js');
 ...
 *
 */
class ConfigServiceApi extends runtime.BaseAPI {
    /**
    ...
    getConfigRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => ConfigtypesGetConfigResponse.ConfigtypesGetConfigResponseFromJSON(jsonValue));
        });
    }
    /**
     * Fetch the current configuration from the server
    ...
    saveConfigRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: ConfigtypesSaveConfigRequest.ConfigtypesSaveConfigRequestToJSON(requestParameters['request']),
            }, initOverrides);
...
exports.ConfigServiceApi = ConfigServiceApi;
