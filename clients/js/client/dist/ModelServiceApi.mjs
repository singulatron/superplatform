...
import { ModeltypesGetModelResponseFromJSON } from './ModeltypesGetModelResponse.mjs';
import { ModeltypesListResponseFromJSON } from './ModeltypesListResponse.mjs';
import { ModeltypesStatusResponseFromJSON } from './ModeltypesStatusResponse.mjs';
import './ModeltypesModel.mjs';
import './ModeltypesPlatform.mjs';
import './ModeltypesArchitectures.mjs';
import './ModeltypesContainer.mjs';
import './ModeltypesModelStatus.mjs';
 ...
 *
 */
class ModelServiceApi extends BaseAPI {
    /**
    ...
    getModelRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new JSONApiResponse(response, (jsonValue) => ModeltypesGetModelResponseFromJSON(jsonValue));
        });
    }
    /**
     * Retrieves the details of a model by its ID.  the Requires `model.view` permission.
    ...
    getModelStatusRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new JSONApiResponse(response, (jsonValue) => ModeltypesStatusResponseFromJSON(jsonValue));
        });
    }
    /**
     * Retrieves the status of a model by ID.  Requires the `model-svc:model:view` permission.
    ...
    listModelsRaw(initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new JSONApiResponse(response, (jsonValue) => ModeltypesListResponseFromJSON(jsonValue));
        });
    }
    /**
     * Retrieves a list of models after checking authorization Requires \"model.view\" permission.
