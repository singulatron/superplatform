 ...
 */
export function instanceOfPrompttypesAddPromptRequest(value: object): value is PrompttypesAddPromptRequest {
    if (!('prompt' in value) || value['prompt'] === undefined) return false;
    return true;
}

export function PrompttypesAddPromptRequestFromJSON(json: any): PrompttypesAddPromptRequest {
    return PrompttypesAddPromptRequestFromJSONTyped(json, false);
}

export function PrompttypesAddPromptRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrompttypesAddPromptRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function PrompttypesAddPromptRequestToJSON(value?: PrompttypesAddPromptRequest | null): any {
    if (value == null) {
        return value;
    }
    return {
