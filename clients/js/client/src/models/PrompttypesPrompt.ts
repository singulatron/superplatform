...
import {
    PrompttypesPromptStatusFromJSON,
    PrompttypesPromptStatusFromJSONTyped,
    PrompttypesPromptStatusToJSON,
} from './PrompttypesPromptStatus';
 ...
 */
export function instanceOfPrompttypesPrompt(value: object): value is PrompttypesPrompt {
    if (!('prompt' in value) || value['prompt'] === undefined) return false;
    return true;
}

export function PrompttypesPromptFromJSON(json: any): PrompttypesPrompt {
    return PrompttypesPromptFromJSONTyped(json, false);
}

export function PrompttypesPromptFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrompttypesPrompt {
    if (json == null) {
        return json;
    }
    return {
        ...
        'status': json['status'] == null ? undefined : PrompttypesPromptStatusFromJSON(json['status']),
...
export function PrompttypesPromptToJSON(value?: PrompttypesPrompt | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'status': PrompttypesPromptStatusToJSON(value['status']),
        'sync': value['sync'],
