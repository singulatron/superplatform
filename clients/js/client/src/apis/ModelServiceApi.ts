...
import type {
  ModeltypesErrorResponse,
  ModeltypesGetModelResponse,
  ModeltypesListResponse,
  ModeltypesStatusResponse,
} from '../models/index';
import {
    ModeltypesErrorResponseFromJSON,
    ModeltypesErrorResponseToJSON,
    ModeltypesGetModelResponseFromJSON,
    ModeltypesGetModelResponseToJSON,
    ModeltypesListResponseFromJSON,
    ModeltypesListResponseToJSON,
    ModeltypesStatusResponseFromJSON,
    ModeltypesStatusResponseToJSON,
} from '../models/index';
 ...
 * 
 */
export class ModelServiceApi extends runtime.BaseAPI {

    /**
     * Retrieves the details of a model by its ID.  the Requires `model.view` permission.
     * Get a Model
     */
    async getModelRaw(requestParameters: GetModelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModeltypesGetModelResponse>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ModeltypesGetModelResponseFromJSON(jsonValue));
    }
     ...
     * Get a Model
     */
    async getModel(requestParameters: GetModelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModeltypesGetModelResponse> {
     ...
     * Get Model Status
     */
    async getModelStatusRaw(requestParameters: GetModelStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModeltypesStatusResponse>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling getModelStatus().'
            );
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ModeltypesStatusResponseFromJSON(jsonValue));
    }
     ...
     * Get Model Status
     */
    async getModelStatus(requestParameters: GetModelStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModeltypesStatusResponse> {
     ...
     * List Models
     */
    async listModelsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModeltypesListResponse>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ModeltypesListResponseFromJSON(jsonValue));
    }
     ...
     * List Models
     */
    async listModels(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModeltypesListResponse> {
