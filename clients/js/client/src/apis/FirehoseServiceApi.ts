...
import type {
  FirehosetypesErrorResponse,
  FirehosetypesPublishRequest,
} from '../models/index';
import {
    FirehosetypesErrorResponseFromJSON,
    FirehosetypesErrorResponseToJSON,
    FirehosetypesPublishRequestFromJSON,
    FirehosetypesPublishRequestToJSON,
} from '../models/index';

export interface FirehoseSvcPublishPostRequest {
    event: FirehosetypesPublishRequest;
}

/**
 * 
 */
export class FirehoseServiceApi extends runtime.BaseAPI {
    ...
    async firehoseSvcPublishPostRaw(requestParameters: FirehoseSvcPublishPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        const response = await this.request({
            ...
            body: FirehosetypesPublishRequestToJSON(requestParameters['event']),
        }, initOverrides);
