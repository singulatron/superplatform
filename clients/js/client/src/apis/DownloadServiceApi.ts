...
import type {
  DownloadtypesDownloadRequest,
  DownloadtypesDownloadsResponse,
  DownloadtypesErrorResponse,
  DownloadtypesGetDownloadResponse,
} from '../models/index';
import {
    DownloadtypesDownloadRequestFromJSON,
    DownloadtypesDownloadRequestToJSON,
    DownloadtypesDownloadsResponseFromJSON,
    DownloadtypesDownloadsResponseToJSON,
    DownloadtypesErrorResponseFromJSON,
    DownloadtypesErrorResponseToJSON,
    DownloadtypesGetDownloadResponseFromJSON,
    DownloadtypesGetDownloadResponseToJSON,
} from '../models/index';

export interface DownloadRequest {
    request: DownloadtypesDownloadRequest;
}
 ...
 * 
 */
export class DownloadServiceApi extends runtime.BaseAPI {
    ...
    async downloadRaw(requestParameters: DownloadRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<{ [key: string]: any; }>> {
        ...
        const response = await this.request({
            ...
            body: DownloadtypesDownloadRequestToJSON(requestParameters['request']),
        }, initOverrides);
     ...
     * Get a Download
     */
    async getDownloadRaw(requestParameters: GetDownloadRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DownloadtypesGetDownloadResponse>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => DownloadtypesGetDownloadResponseFromJSON(jsonValue));
    }
     ...
     * Get a Download
     */
    async getDownload(requestParameters: GetDownloadRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DownloadtypesGetDownloadResponse> {
     ...
     * List Downloads
     */
    async listDownloadsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DownloadtypesDownloadsResponse>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => DownloadtypesDownloadsResponseFromJSON(jsonValue));
    }
     ...
     * List Downloads
     */
    async listDownloads(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DownloadtypesDownloadsResponse> {
