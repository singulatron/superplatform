...
export declare class ChatSvcApi {
     ...
     */
    addMessage(threadId: string, request: ChatSvcAddMessageRequest, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    addThread(request: ChatSvcAddThreadRequest, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    updateThread(threadId: string, request: ChatSvcUpdateThreadRequest, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
