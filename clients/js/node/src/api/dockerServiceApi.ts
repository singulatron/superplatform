...
export enum DockerServiceApiApiKeys {
    BearerAuth,
}

export class DockerServiceApi {
    ...
    public setApiKey(key: DockerServiceApiApiKeys, value: string) {
        (this.authentications as any)[DockerServiceApiApiKeys[key]].apiKey = value;
    }
