...
export class ChatSvcApi {
     ...
     */
    public async addMessage (threadId: string, request: ChatSvcAddMessageRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: { [key: string]: any; };  }> {
     ...
     */
    public async addThread (request: ChatSvcAddThreadRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ChatSvcAddThreadResponse;  }> {
     ...
     */
    public async updateThread (threadId: string, request: ChatSvcUpdateThreadRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ChatSvcAddThreadResponse;  }> {
        const localVarPath = this.basePath + '/chat-svc/thread/{threadId}'
            .replace('{' + 'threadId' + '}', encodeURIComponent(String(threadId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
