...
import { ModelSvcErrorResponse } from '../model/modelSvcErrorResponse';
import { ModelSvcGetModelResponse } from '../model/modelSvcGetModelResponse';
import { ModelSvcListResponse } from '../model/modelSvcListResponse';
...
export enum ModelSvcApiApiKeys {
    BearerAuth,
}
...
export class ModelSvcApi {
    ...
    public setApiKey(key: ModelSvcApiApiKeys, value: string) {
        (this.authentications as any)[ModelSvcApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async getDefaultModelStatus (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ModelSvcStatusResponse;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ModelSvcStatusResponse;  }>((resolve, reject) => {
     ...
     */
    public async getModel (modelId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ModelSvcGetModelResponse;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ModelSvcGetModelResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
     ...
     * @param modelId Model ID
     */
    public async getModelStatus (modelId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ModelSvcStatusResponse;  }> {
    ...
    public async listModels (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ModelSvcListResponse;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ModelSvcListResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
     ...
     * @param modelId Model ID
     */
    public async makeDefault (modelId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: object;  }> {
     ...
     * @param modelId Model ID
     */
    public async startModel (modelId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: object;  }> {
