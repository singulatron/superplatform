...
func GetChatThread(w http.ResponseWriter, r *http.Request, ds *appservice.AppService) {
	req := types.GetChatThreadRequest{}
	...
	jsonData, _ := json.Marshal(types.GetChatThreadResponse{
		Thread: *thread,
	})
	w.Write(jsonData)
}
