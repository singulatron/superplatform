...
func UpdateChatThread(w http.ResponseWriter, r *http.Request, ds *appservice.AppService) {
	req := types.UpdateChatThreadRequest{}
	...
	thread, err := ds.UpdateChatThread(req.Thread)
	if err != nil {
