...
require (
	...
	github.com/singulatron/superplatform/clients/go v0.0.0 // indirect
	github.com/singulatron/superplatform/sdk/go v0.0.0-00010101000000-000000000000 // indirect
