...
import { Condition, equal, contains, startsWith, field } from './generic.service'; // Adjust the path as needed
...
describe('QueryParser', () => {
  ...
  it('should parse a full query string correctly', () => {
    const queryString = 'name:^John description:~keyword age:30 orderBy:name:asc,age:desc limit:10 after:id1,id2';
    const query = parser.parse(queryString);
